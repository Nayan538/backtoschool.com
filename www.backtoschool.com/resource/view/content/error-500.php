...
if($pageTitle == 'error-500.php')
{
	$pageTitle = 'EMS | ERROR-500';
}
## ===*=== [P]AGE TITLE ===*=== ##
?>
			...
			<div class="account-page">
				<div class="container">
					<div class="text-center text-light">
						<h2 style="font-size: 96px;">500</h2>
						<h3 class="text-uppercase"> 
							Oops! <span style="font-weight: 300;"> Something went wrong </span>
						</h3>
						<p>The page you requested was not found.</p>
						<a href="index.php" class="btn btn-outline-light btn-rounded go-home"> Go back to Home </a>
					</div>
				</div>
			</div>
		</div>
